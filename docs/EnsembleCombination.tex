...
\end{itemize}
In summary, forecasters are encouraged to analyze the data prior to specify the combination strategy and choose combination rules tailored to specific forecasting problems.
...
\citep{Genest1990-sr,Nowotarski2015-xu,Conflitti2015-fq,Billio2013-sg,Wallis2005-yf}
