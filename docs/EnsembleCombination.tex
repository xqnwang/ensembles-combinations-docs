...
\begin{itemize}
  \item linear opinion pool \citep{Genest1990-sr}---a convex combination (This phenomenon is often referred to as ... in the literature; see, e.g.,...)
